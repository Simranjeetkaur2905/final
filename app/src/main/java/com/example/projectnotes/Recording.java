...
public class Recording extends AppCompatActivity {
    ...
    Button btnPlay, btnStop, btnRecord, btnStopRecord, btnsaverecording;
    String pathSave = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsaverecording = findViewById(R.id.save_recording);
...
//                            + RECORDED_FILE;
                    ...
                    Toast.makeText(Recording.this, "Recording...", Toast.LENGTH_SHORT).show();
                } else
                    requestPermission();
            }
        });
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Toast.makeText(Recording.this, "Playing...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnsaverecording.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Recording.this,detailofnotes.class);
